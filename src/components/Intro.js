    ...
    return (
      <div>
        ...
        <div className="wraper">
          ...
          <p className="pal2">
            El exámen de Cívica consiste en una prueba oral y el oficial de USCIS
            le rpeguntará al aspirante un máximo de 10 preguntas.
            <b>
              <br></br>El aplicante tiene que responder correctamente al menos 6
              de las 10 preguntas para aprobar la sección de Cívica del exámen de
              Naturalización.
            </b>
          </p>
          <p className="pal3">
